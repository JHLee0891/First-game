...
public class Enemy : MonoBehaviour
{
    ...
    void FireShot()
    {
        for(int index=0; index < 5; index++)
        {
            ...
            Vector2 ranVec = new Vector2(Random.Range(-1.5f, 1.5f), Random.Range(0f, 2f));
            dirVec += ranVec;
    ...
    void FireArc()
    {
            ...
            Rigidbody2D rigid = bullet.GetComponent<Rigidbody2D>();
            Vector2 dirVec = new Vector2(Mathf.Sin(Mathf.PI * 9 * curPatternCount/maxPatternCount[patternIndex]), -2);
